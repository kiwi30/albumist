...
<div class="site-wrapper">
  ...
  -
            ...
            <div class="twelve columns">
                <nav class="nav">
                    <ul class="menu">
                        <li class="active"><a href="#"><?php echo _("Home")?></a></li>
                        <li><a href="#showcase"><?php echo _("Features")?></a></li>
                        <li><a href="#shots"><?php echo _("Shots")?></a></li>
                        <li><a href="#call-to-action"><?php echo _("Download")?></a></li>
    ...
    <section class="shots" id="shots">
        ...
        <div class="container">
            ...
            <div class="sixteen columns section-title">
                <h1><?php echo _("Shots")?><span style="color:#dad7d7"><?php echo _("what change your life")?></span></h1>
                <div class="title-bullet"><span></span></div>
            </div>
    ...
    <!-- Call to Action -->
    <section class="call-to-action" id="call-to-action" style=" background-image: url(img/tile.jpg);">
        ...
        <div class="container">
            ...
            <div class="sixteen columns call-to-action-content">
                ...
                <div class="but">
                    <a href="https://itunes.apple.com/ru/app/albumist/id1128079856?mt=8"><img src="img/buttons/Untitled-1.png" alt=""></a>
